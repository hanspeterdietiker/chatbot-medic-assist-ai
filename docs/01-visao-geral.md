...
O projeto tem como tema a aplicacao de Inteligencia Artificial em registros hospitalares para apoiar:

- triagem inicial;
- classificacao de urgencia;
- recomendacao da area hospitalar adequada.

O sistema nao realiza diagnostico, nao prescreve medicamentos e nao substitui a avaliacao de profissionais de saude. Sua funcao e organizar informacoes e apoiar o encaminhamento inicial.
